  ...
  return (
    <div className="space-y-4">
      <div className="bg-blue-500 p-4 text-white flex items-center justify-between">
        ...
        <h1 className="text-2xl mx-auto">Quiz</h1> {/* This will center the 'Learn' heading */}
      </div>

      <div className="grid grid-cols-3">
        {Array.from({ length: TOTAL_LESSONS }, (_, i) => i + 1).map((lesson: number) => (
          <Link key={lesson} href={`/quiz/lessons/${lesson}`} className="bg-gray-400 border-2 rounded-md p-4">
